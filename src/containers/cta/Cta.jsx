      ...
      <div className="cta-content">
        <div className="cta-content-left">
          <div className="cta-content-left-text">
            ...
            <h2>
              Les entreprises gagnent en moyenne 11 % de plus dans les 20 jours
        ...
        <div className="cta-content-right">
          ...
          <div className="cta-content-right-bottom">
            ...
            <p>
              Le temps c'est de l'argent et Suggestr est conçu pour des
              performances extrêmes. Se charge plus rapidement qu'une recherche
              Google.
            </p>
          </div>
        </div>
