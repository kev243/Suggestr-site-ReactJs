      ...
      <div className="bacground-container section__margin">
        <div className="container-left ">
          <div className="left-top">
            <h3>
              Obtenez 19 % de conversions en plus sur votre boutique dès
              aujourd'hui.
            </h3>
            <p>
              Accès complet à une IA de qualité recherche qui devient
              continuellement plus intelligente. Faites plaisir à vos clients.
